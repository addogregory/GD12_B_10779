package com.example.gd12_pdf_b_10779
...
import com.example.gd12_pdf_b_10779.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama:String,umur:String,tlp:String,alamat:String,kampus:String){
        ...
        val file = File(pdfPath,"pdf_10779.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.ayaka1)
        ...
        val group = Paragraph(
            """
            Berikut adalah nama pengguna UAJY 2022/2023
